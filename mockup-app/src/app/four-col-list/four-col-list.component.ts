...
@Component({
  selector: 'app-four-col-list',
  templateUrl: './four-col-list.component.html',
  styleUrls: ['./four-col-list.component.scss']
})
export class FourColListComponent implements OnInit {
  loops: number = 12;
  moments: any[] = [
    {
